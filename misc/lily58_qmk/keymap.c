...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LGUI,  KC_Z,   KC_X,    KC_C,            KC_V,    KC_B,             KC_LALT,  KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_PSCR,
                             KC_CAPS, KC_ADJ,  KC_LCTL, LGUI_T(KC_SPC),  KC_ENT,  KC_LSFT, KC_EXT,  _______
),
...
[_ADJUST] = LAYOUT(
  ...
  TAB_R,   _______, _______, _______, KC_MUTE, KC_VOLU,                   KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, KC_F12,
  TAB_L,   _______, _______, _______, _______, KC_VOLD,                   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  KC_LGUI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LCTL,
